...
<?php
	...
	class product
	{
		...
		public function insert_slider($data,$files){
			...
			if($sliderName=="" || $type==""){
				$alert = "<span class='error'>Các trường này không được để trống</span>";
				return $alert;
			}else{
				if(!empty($file_name)){
				    ...
				    $alert = "<span class='success'>Chỉ có thể tải lên các định dạng sau:-".implode(', ', $permited)."</span>";
					return $alert;
					}
					move_uploaded_file($file_temp,$uploaded_image);
		...
		public function del_slider($id){
			...
			if($result){
				...
				$alert = "<span class='error'>Xóa slide thất bại</span>";
				return $alert;
			}
		}
